...
- [GVA System (GV-Analyzer)](#gva-system--gv-analyzer-)
    * [What is GVA System](#what-is-gva-system)
        + [Why GVA System](#why-gva-system)
    ...
    * [Usage](#usage)
        + [Basic usage](#basic-usage)
            - [Example](#example)
        + [Configure file structure](#configure-file-structure)
            - [Configuration Example](#configuration-example)
            - [query](#query)
            - [nodeTypeAttr and edgeTypeAttr](#nodetypeattr-and-edgetypeattr)
        + [Convert Output gv File to PNG File](#convert-output-gv-file-to-png-file)
            - [Example:](#example-)
        + [Run all examples](#run-all-examples)
        + [Example Workthrough](#example-workthrough)
            - [Call GVA System using `run.sh` shortcut:](#call-gva-system-using--runsh--shortcut-)
            - [Check the output of GVA System](#check-the-output-of-gva-system)
                * [HierarchyGraph Directory](#hierarchygraph-directory)
                * [TypeGraph Directory](#typegraph-directory)
* [Reference](#reference)
