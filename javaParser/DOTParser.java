...
public class DOTParser extends Parser {
	...
	public static final int
		...
		RULE_subgraph = 12, RULE_id_decl = 13;
	public static final String[] ruleNames = {
		"graph", "stmt_list", "stmt", "attr_stmt", "attr_list", "a_list", "edge_stmt", 
		"edgeRHS", "edgeop", "node_stmt", "node_id", "port", "subgraph", "id_decl"
	};
	...
	public static class StmtContext extends ParserRuleContext {
		...
		public List<Id_declContext> id_decl() {
			return getRuleContexts(Id_declContext.class);
		}
		public Id_declContext id_decl(int i) {
			return getRuleContext(Id_declContext.class,i);
		}
	...
	public static class Id_declContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DOTListener ) ((DOTListener)listener).enterId_decl(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DOTListener ) ((DOTListener)listener).exitId_decl(this);
		}
	}

	public final Id_declContext id_decl() throws RecognitionException {
		Id_declContext _localctx = new Id_declContext(_ctx, getState());
		enterRule(_localctx, 26, RULE_id_decl);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
