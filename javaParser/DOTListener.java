...
public interface DOTListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DOTParser#id_decl}.
	 * @param ctx the parse tree
	 */
	void enterId_decl(DOTParser.Id_declContext ctx);
	/**
	 * Exit a parse tree produced by {@link DOTParser#id_decl}.
	 * @param ctx the parse tree
	 */
	void exitId_decl(DOTParser.Id_declContext ctx);
}